    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reg_status_investig', models.NullBooleanField(help_text='INVESTIGATION')),
                ...
                ('doc_signed_by', models.CharField(blank=True, help_text='document signed by', null=True, max_length=250)),
