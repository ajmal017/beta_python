...
class Event(ChoiceEnum):
    ...
    TAX_LOSS_HARVESTED = (51, [], 'main.Goal')

    # annual/quarterly statements to be generated by system
    STATEMENTS_GENERATED = (52, [], 'main.Goal')

    # annual tax forms to be generated by system
    TAX_FORMS_GENERATED = (53, [], 'main.Goal')

    # Documents - copies of Statements of Advice and Records of Advice
    DOCUMENTS_GENERATED = (54, [], 'main.Goal')

    # Other - any other documents/letters issued to the client by admin/advisor/firm
    OTHERS_GENERATED = (55, [], 'main.Goal')
