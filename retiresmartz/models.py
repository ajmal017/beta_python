...
class RetirementProjection(models.Model):
    ...
    accounts_401a = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_401k = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_403b = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_403k = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_409a = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_457 = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_esop = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_gov = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_ind_401k = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_ind_roth_401k = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_ira = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_mon_purch = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_pay_deduct_ira = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_prof_sharing = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_qual_annuity = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_qual_np = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_qual_np_roth = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_priv_457 = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_roth_401k = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_roth_ira = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_sarsep_ira = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_sep_ira = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_simple_ira = JSONField(null=True, blank=True, help_text="List of annual accounts")
    accounts_tax_def_annuity = JSONField(null=True, blank=True, help_text="List of annual accounts")
    ...
    part_accounts_401a = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_401k = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_403b = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_403k = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_409a = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_457 = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_esop = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_gov = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_ind_401k = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_ind_roth_401k = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_ira = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_mon_purch = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_pay_deduct_ira = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_prof_sharing = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_qual_annuity = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_qual_np = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_qual_np_roth = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_priv_457 = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_roth_401k = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_roth_ira = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_sarsep_ira = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_sep_ira = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_simple_ira = JSONField(null=True, blank=True, help_text="List of annual accounts")
    part_accounts_tax_def_annuity = JSONField(null=True, blank=True, help_text="List of annual accounts")
