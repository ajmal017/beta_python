    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pc_1', models.FloatField(validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)], help_text='Rate value (0 - 1) for income $0 - $19,999')),
                ('pc_2', models.FloatField(validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)], help_text='Rate value (0 - 1) for income $20,000 - $29,999')),
                ('pc_3', models.FloatField(validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)], help_text='Rate value (0 - 1) for income $30,000 - $39,999')),
                ('pc_4', models.FloatField(validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)], help_text='Rate value (0 - 1) for income $40,000 - $49,999')),
                ('pc_5', models.FloatField(validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)], help_text='Rate value (0 - 1) for income $50,000 - $69,999')),
                ('pc_7', models.FloatField(validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)], help_text='Rate value (0 - 1) for income $70,000 +')),
